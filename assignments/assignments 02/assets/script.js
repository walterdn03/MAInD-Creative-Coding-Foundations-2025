...
const GAME_SPEED = 110; //velocità minima
const OBSTACLE_COUNT = 5; //num ostacoli
...
function startGame() {
    ...
    const speed = Math.max(GAME_SPEED, avatars[selectedAvatar].speed);
